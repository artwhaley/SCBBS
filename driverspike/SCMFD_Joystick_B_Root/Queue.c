...
NTSTATUS
SCMFD_Joystick_B_RootQueueInitialize(
    ...
    )
{
    ...
    queueConfig.EvtIoDeviceControl = SCMFD_Joystick_B_RootEvtIoDeviceControl;
    queueConfig.EvtIoStop = SCMFD_Joystick_B_RootEvtIoStop;
...
VOID
SCMFD_Joystick_B_RootEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
...
{
    SCMFD_Joystick_B_RootEvtIoHidDeviceControl(Queue, Request, OutputBufferLength, InputBufferLength, IoControlCode);
}

VOID
SCMFD_Joystick_B_RootEvtIoStop(
    _In_ WDFQUEUE Queue,
    _In_ WDFREQUEST Request,
