...
NTSTATUS
SCMFD_Joystick_A_RootQueueInitialize(
    ...
    )
{
    ...
    queueConfig.EvtIoDeviceControl = SCMFD_Joystick_A_RootEvtIoDeviceControl;
    queueConfig.EvtIoStop = SCMFD_Joystick_A_RootEvtIoStop;
...
VOID
SCMFD_Joystick_A_RootEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
...
{
    SCMFD_Joystick_A_RootEvtIoHidDeviceControl(Queue, Request, OutputBufferLength, InputBufferLength, IoControlCode);
}

VOID
SCMFD_Joystick_A_RootEvtIoStop(
    _In_ WDFQUEUE Queue,
    _In_ WDFREQUEST Request,
